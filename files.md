...
<Context>
**Task**: The file `compass_artifact_wf-32d3a9b8-6e8d-4b8a-afa5-5f83872d517c_text_markdown.md` a comprehensive guide for building custom NixOS ISO images on macOS Apple Silicon (specifically for x86_64 architecture) through cross-compilation. Your goal is to use this guide to implement in this repository so that a NixOS iso image can be built embedding the configuration and flakes define in the folder `servo/`.
**Desired parallelism**: 3  (1-3 is typical)
...
3. Spawn 3 parallel **Specialist** agents with shared context.
